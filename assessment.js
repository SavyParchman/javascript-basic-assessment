...
//It looks to see if the person’s name is Jeremy and then changes the person object to have 
//a property called lovesCode with a value of 10.  If their name is Brack set lovesCode to 0.  
